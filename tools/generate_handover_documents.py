...
SECTIONS = [
 ...
 ("8. Verification results", [
  "72 repository tests and 3 stress tests passed. Retrieval Hit@5 and Top-1 accuracy were 100%; Mean Reciprocal Rank was 1.000; document routing, positive acceptance, negative rejection, grounded supported-case acceptance, and grounding-guard rejection were 100%.",
...
SLIDES = [
 ...
 ("Measured verification", ["72 repository tests + 3 stress tests passed","Hit@5 100% · Top-1 100% · MRR 1.000","Routing 100%","Positive acceptance 100% · negative rejection 100%","Grounding acceptance 100% · guard rejection 100%","Metrics apply only to labelled controlled sets"], TEAL),
